...
export function AboutSection() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-20 bg-[radial-gradient(circle_at_18%_20%,rgba(216,155,58,0.08),transparent_30%),radial-gradient(circle_at_78%_38%,rgba(80,72,64,0.12),transparent_34%),linear-gradient(180deg,#05070b_0%,#070b12_50%,#05070b_100%)]"
      />
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-[-8rem] top-24 -z-10 h-96 w-96 rounded-full bg-[#d89b3a]/[0.045] blur-3xl"
      />
      ...
      <div className="mx-auto grid w-full max-w-[1240px] items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div className="hero-reveal max-w-3xl">
          ...
          <p className="mt-7 max-w-2xl border-l border-[#d89b3a]/22 pl-5 text-base leading-8 text-slate-400 sm:text-lg">
        ...
        >
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(rgba(216,155,58,0.026)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.018)_1px,transparent_1px)] bg-[size:38px_38px] opacity-40"
          />
          <div
            aria-hidden="true"
            className="absolute -right-16 -top-16 h-44 w-44 rounded-full bg-[#d89b3a]/[0.045] blur-3xl transition-opacity duration-300 group-hover:opacity-100"
          />
          ...
          <div className="relative flex items-center justify-between gap-4">
            ...
            <span
              aria-hidden="true"
              className="h-2.5 w-2.5 rounded-full bg-[#d89b3a]/78 shadow-[0_0_20px_rgba(216,155,58,0.34)]"
            />
          </div>

          <div className="relative mt-6 rounded-2xl border border-[#d89b3a]/14 bg-black/10 p-3">
            <div className="flex items-center gap-2 rounded-full border border-[#d89b3a]/22 bg-[#d89b3a]/[0.055] px-3 py-2 text-xs font-medium text-[#f3d38a]/82">
              <span
                aria-hidden="true"
          ...
          <div className="relative mt-6 space-y-2.5">
            {profileRows.map((row) => (
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className="h-1.5 w-1.5 rounded-full bg-[#d89b3a]/62 shadow-[0_0_10px_rgba(216,155,58,0.22)]"
                />
              </div>
            ))}
          </div>
          ...
          <div className="relative mt-6 grid gap-2 sm:grid-cols-3">
            {metrics.map((metric) => (
              ...
              >
                <p className="font-mono text-xs text-[#d89b3a]/62">
                  {metric.value}
                </p>
